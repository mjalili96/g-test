...
namespace {
    ...
    INSTANTIATE_TEST_SUITE_P(SelectionSortBubbleSort, SortTest2,
                             testing::Values(SelectionSort, BubbleSort));

    TEST_P(SortTest2, SmallNumberOfItems) {
    ...
    TEST_P(SortTest2, EmptyCollection) {
        std::vector<int> in = {};
    ...
    TEST_P(SortTest2, SingleElement) {
        std::vector<int> in = {3};
    ...
    TEST_P(SortTest2, WithDuplicates) {
    ...
    TEST_P(SortTest2, RandomLargeVector) {
        std::vector<int> in;
        std::vector<int> expected;
        auto sort_func = GetParam();
    ...
    TEST_P(SortTest2, RandomLargeVectorSorted) {
        std::vector<int> in;
        std::vector<int> expected;
        auto sort_func = GetParam();
    ...
    TEST_P(SortTest2, RandomLargeVectorReverseSorted) {
        std::vector<int> in;
        std::vector<int> expected;
        auto sort_func = GetParam();
    ...
    TEST_P(SortTest2, RandomLargeVectorMultipleSeeds) {
        std::vector<int> in;
        std::vector<int> expected;
        auto sort_func = GetParam();
